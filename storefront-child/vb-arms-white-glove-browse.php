...
<body>
    ...
    <section class="browse-section">
        <div class="partner-catalogs-box">
            ...
            <div class="browse-partners">
                ...
                <span class="browse-partners-sep">•</span>
                <a href="https://www.rsrgroup.com/" target="_blank" rel="noopener noreferrer">RSR Group <span class="partner-note">(accessories only)</span></a>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.registry-form').reset();
        });
    </script>
    <?php endif; ?>
