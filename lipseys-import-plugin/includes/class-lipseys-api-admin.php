...
class Lipseys_API_Admin {
    ...
    public function render_page() {
        ...
        <div class="wrap">
            ...
            <p class="description">
                <?php esc_html_e("API is used for live catalog/ordering. If your WordPress host's IP is not whitelisted, use a proxy (your server with whitelisted IP). Payment: Authorize.net for checkout; orders submitted here to Lipsey's.", 'lipseys-import'); ?>
            </p>
